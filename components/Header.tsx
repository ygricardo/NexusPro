    ...
    return (
        <>
            ...
            {user?.subscription_status === 'past_due' && (
                <div className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white px-4 py-2.5 flex items-center justify-between gap-4 text-sm font-semibold shadow-lg z-50">
                    <div className="flex items-center gap-2">
                        <span className="material-symbols-outlined text-[20px] animate-pulse">warning</span>
                        <span>
                            ⚠️ <strong>Payment failed.</strong> Your card was declined. Update your payment method to keep access to all modules.
                        </span>
                    </div>
                    <Link
                        to="/plans"
                        className="shrink-0 px-4 py-1.5 bg-white text-red-600 rounded-lg font-black text-xs uppercase tracking-wider hover:bg-red-50 transition-all shadow"
                    >
                        Update Payment →
                    </Link>
                </div>

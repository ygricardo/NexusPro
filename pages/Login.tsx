...
const Login = () => {
    ...
    const { signIn, signInWithGoogle, user, signOut } = useUser();
            ...
            <div className="flex w-full flex-col justify-center px-6 py-12 lg:px-20 xl:px-24 w-full lg:w-1/2 z-10 relative bg-midnight/50 backdrop-blur-sm lg:backdrop-blur-none">
                <div className="mx-auto w-full max-w-sm lg:w-96 flex flex-col justify-center h-full">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="w-full py-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-bold text-base transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {googleLoading ? (
